...
fun main() {
    ...
    val payments = listOf(
        ...
        Payment(card = "5111111111111111", sum = 2000, type = CardType.MASTERCARD),
        Payment(card = "2222222222222222", sum = 1500, type = CardType.MIR),
    ...
    payments.forEach { payment ->
        println("\nПлатёж ${payment.type}: ${payment.card.take(n = 4)}..., ${payment.sum} руб")
